...
const topics = [
  {
    ...
    description: "Discuss your relationships and social life",
    image:
      "https://images.unsplash.com/photo-1513635269975-59663e0ac1ad?ixlib=rb-4.0.3",
  },
  {
    title: "Work & Study",
    description: "Talk about your career and education",
    image:
      "https://images.unsplash.com/photo-1513635269975-59663e0ac1ad?ixlib=rb-4.0.3",
  },
  {
    title: "Hobbies & Interests",
    description: "Share your passions and free time activities",
    image:
      "https://images.unsplash.com/photo-1513635269975-59663e0ac1ad?ixlib=rb-4.0.3",
  },
  {
    title: "Daily Life",
    description: "Describe your routine and habits",
    image:
      "https://images.unsplash.com/photo-1513635269975-59663e0ac1ad?ixlib=rb-4.0.3",
  },
];
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {topics.map((topic, index) => (
              ...
              >
                ...
                />
                <div className="absolute inset-0 bg-gradient-to-t from-[#012169]/80 to-[#012169]/90" />
